          ...
          <div className="container mx-auto px-4 max-w-4xl">
            ...
            <div className="mt-6 space-y-5 text-lg leading-relaxed [&_p]:text-gray-100">
              ...
              <p className="text-gray-300">
                The point for a seller is simple. Spending a few thousand dollars to make your trees an asset instead of a liability is one of the highest-return moves you can make before a listing — right up there with paint and landscaping, and often cheaper than either. And when the landscaping side needs attention too — reseeding the lawn that finally gets light again, fresh beds, and full cleanup — we hand it to the crew we do the tree work for, <a href="https://virginialawnsllc.com" target="_blank" rel="noopener noreferrer" className="text-[#D4AF37] font-semibold underline hover:text-white">Virginia Lawns</a>, so the whole yard shows as one finished picture.
              </p>
            </div>
          </div>
        </section>
