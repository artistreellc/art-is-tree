  ...
  return (
    <footer className="bg-[#1B4D3E] text-white pt-16 pb-8 border-t-[10px] border-[#D4AF37] relative overflow-hidden contain-content footer-contain" role="contentinfo" style={{ contain: 'layout style paint' }}>
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-7 gap-x-8 gap-y-10 mb-12">
          ...
          <div className="flex flex-col">
            ...
            <ul className="space-y-4">
              ...
              <li className="h-[24px]"><Link to="/financing" className="text-gray-300 hover:text-white transition-colors flex items-center gap-2 group h-full"><span className="w-1.5 h-1.5 rounded-full bg-[#D4AF37] opacity-0 group-hover:opacity-100 transition-opacity inline-block"></span>Financing</Link></li>
              <li className="h-[24px]"><a href="/acorn-finance-overview.pdf" target="_blank" rel="noopener" className="text-gray-300 hover:text-white transition-colors flex items-center gap-2 group h-full"><span className="w-1.5 h-1.5 rounded-full bg-[#D4AF37] opacity-0 group-hover:opacity-100 transition-opacity inline-block"></span>Financing Overview (PDF)</a></li>
