      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          ...
          <div className="flex flex-col items-center">
            ...
            <h3 className="font-bold text-xl text-[#1B4D3E] mb-2">17 Years Experience</h3>
            <p className="text-gray-600">Expert tree care crews serving Hampton Roads</p>
          </div>
          <div className="flex flex-col items-center">
            <ThumbsUp className="w-12 h-12 text-[#1B4D3E] mb-4" />
            <h3 className="font-bold text-xl text-[#1B4D3E] mb-2">{reviewRating.toFixed(1)} Star Rating</h3>
