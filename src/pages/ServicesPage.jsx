  ...
  return (
    <div className="bg-gray-50 min-h-screen pt-0 pb-24">
      <LocalSEOMeta 
        ...
        description="Tree service in Virginia Beach and Hampton Roads: removal, trimming, stump grinding, crane work, land clearing and 24/7 emergency service. Licensed, insured. Free estimates."
      />
