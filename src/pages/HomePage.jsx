...
// TrustAndCredentialsSection (Licensed & Insured / 17 Years / live Google rating)
        ...
        <header className="relative isolate text-white py-28 md:py-40 overflow-hidden flex items-center justify-center text-center">
          ...
          <div className="container relative z-10 px-4">
            ...
            <p className="text-xl md:text-2xl text-gray-200 max-w-3xl mx-auto font-light mb-6 drop-shadow speakable">
              Tree removal, trimming, stump grinding, and 24/7 storm cleanup across Virginia Beach and Hampton Roads. Licensed, insured, BBB A+, and rated {COMPANY_INFO.rating.value} across {COMPANY_INFO.rating.reviewCount} reviews &mdash; with the crane and the experience to take on the jobs other companies turn down.
            </p>
        ...
        <section className="py-16 bg-white border-b border-gray-100">
          <div className="container mx-auto px-4 max-w-5xl">
            ...
            <div className="prose prose-lg text-gray-700 leading-relaxed font-light text-left mx-auto max-w-none space-y-6">
              ...
              <p>
                The standard is the same whether the job is large or small. From routine <Link to="/services/tree-trimming" className="text-[#1B4D3E] underline hover:text-[#D4AF37] font-semibold">tree trimming in Virginia Beach</Link> to a high-risk <Link to="/services/tree-removal" className="text-[#1B4D3E] underline hover:text-[#D4AF37] font-semibold">tree removal in Virginia Beach</Link>, a <Link to="/services/crane-removal" className="text-[#1B4D3E] underline hover:text-[#D4AF37] font-semibold">crane tree removal service</Link> for the trees with nowhere to fall, <Link to="/services/stump-grinding" className="text-[#1B4D3E] underline hover:text-[#D4AF37] font-semibold">stump grinding</Link> taken below grade, or <Link to="/emergency" className="text-[#1B4D3E] underline hover:text-[#D4AF37] font-semibold">emergency tree service</Link> after a storm, the work is done right and the site is left clean. Call <a href="tel:7573195131" className="text-[#1B4D3E] underline hover:text-[#D4AF37] font-semibold">(757) 319-5131</a> for a free estimate &mdash; every call reaches a person, not a machine.
              </p>
            </div>
          </div>
        </section>
