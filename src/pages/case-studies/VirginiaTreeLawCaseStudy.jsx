        ...
        <section className="bg-white border-y border-gray-100 py-14 md:py-20">
          <div className="container mx-auto px-4 max-w-4xl">
            ...
            <div className="mt-8 pt-6 border-t border-gray-200 text-sm text-gray-500 space-y-2">
              ...
              <p id="s3" className="m-0">3. <em>Fancher v. Fagella</em>, 274 Va. 549 (2007), Supreme Court of Virginia, <a href="https://caselaw.findlaw.com/court/va-supreme-court/1153823.html" target="_blank" rel="noopener noreferrer" className="text-[#1B4D3E] underline hover:text-[#D4AF37]">full opinion via FindLaw</a> — the self-help rule and the nuisance standard for encroaching trees.</p>
        ...
        <section className="container mx-auto px-4 max-w-4xl py-14 md:py-20">
          <div className="bg-[#0A2F24] text-white rounded-3xl p-8 md:p-12 text-center shadow-xl border-t-4 border-[#D4AF37]">
            ...
            <p className="text-gray-300 text-lg mb-8 max-w-2xl mx-auto">
              ...
              We’ll tell you honestly what Virginia law allows on your specific situation before any cutting begins — across <Link to="/service-areas/virginia-beach" className="text-[#D4AF37] font-semibold underline hover:text-white">Virginia Beach</Link>, <Link to="/service-areas/norfolk" className="text-[#D4AF37] font-semibold underline hover:text-white">Norfolk</Link>, <Link to="/service-areas/chesapeake" className="text-[#D4AF37] font-semibold underline hover:text-white">Chesapeake</Link>, and <Link to="/service-areas/portsmouth" className="text-[#D4AF37] font-semibold underline hover:text-white">Portsmouth</Link>. The assessment is free.
            </p>
