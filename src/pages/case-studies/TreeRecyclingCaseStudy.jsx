...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer: "Regional pulpwood and chips feed the Smurfit WestRock containerboard mill in West Point, the International Paper fluff-pulp mill in Franklin, and Dominion Energy's Southampton biomass power station, which burns waste wood to make electricity. At the mill, chip vans tip up on a hydraulic dumper and a grapple crane pulls a whole bunk of logs off the trailer at once. Mulch and firewood stay local. It's a real, working market that runs out of Virginia Beach and Hampton Roads every day.",
  },
];
          ...
          <div className="grid lg:grid-cols-12 gap-8 items-stretch">
            ...
            <div className="lg:col-span-5">
              <ProjectSpec rows={[
                ...
                ['At the mill', 'Chip vans tip up on their tail; a grapple crane grabs a whole bunk of logs'],
