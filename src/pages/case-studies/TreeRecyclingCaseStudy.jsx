      ...
      <article className="bg-[#FAF9F6]">
        ...
        <section className="bg-white border-y border-gray-100 py-14 md:py-20">
          <div className="container mx-auto px-4 max-w-4xl">
            ...
            {/* sources — four citations are plain text, not links: their URLs stopped
                resolving (Semrush Site Audit, Sep 2026). Each of those entries
                keeps a second, working source link. */}
            <div className="mt-10 pt-6 border-t border-gray-200 text-sm text-gray-500 space-y-2">
              ...
              <p id="src5" className="m-0">5. Dominion Energy, <a href="https://www.dominionenergy.com/projects-and-facilities/biomass-fuel-facilities" target="_blank" rel="noopener noreferrer" className="text-[#1B4D3E] underline hover:text-[#D4AF37]">Biomass Fuel Facilities</a>, and Virginia Places, <cite>Biomass Energy in Virginia</cite> — Southampton coal-to-biomass conversion, ~51 MW, and regional wood-fuel tonnage.</p>
              <p id="src6" className="m-0">6. Montague Legacy Group, <a href="https://www.montaguelegacygroup.com/truck-dumpers.html" target="_blank" rel="noopener noreferrer" className="text-[#1B4D3E] underline hover:text-[#D4AF37]">Hydraulic Truck Dumpers &amp; Trailer Tippers</a>, and Drax, <cite>“This is how you unload a wood chip truck”</cite> — semi-towed chip trailers tip to roughly 60° on a hydraulic dumper to unload.</p>
              <p id="src7" className="m-0">7. Konecranes, <cite>Woodyard Cranes</cite>, and Andritz, <a href="https://www.andritz.com/products-en/pulp-and-paper/pulp-production/woodyard/log-handling" target="_blank" rel="noopener noreferrer" className="text-[#1B4D3E] underline hover:text-[#D4AF37]">Log-Yard Cranes</a> — radial/pedestal grapple cranes unload a full bunk of logs at a time.</p>
            </div>
          </div>
        </section>
