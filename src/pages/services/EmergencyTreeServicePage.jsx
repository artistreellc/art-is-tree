...
const EmergencyTreeServicePage = () => {
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      ...
      <section className="bg-gradient-to-br from-[#1B4D3E] to-[#0A2F24] pt-24 pb-16 px-4">
        <div className="container mx-auto max-w-5xl text-center">
          ...
          <p className="text-lg md:text-xl text-gray-200 max-w-3xl mx-auto mb-10 leading-relaxed">
            The tree is off the roof. Now comes the adjuster, the estimate, and the question of who pays for what. This is the part nobody explains: what a homeowners policy actually covers after a storm, what your adjuster needs in writing, who is liable when the tree came from next door, and why a crane changes the number. Art-is-Tree LLC has documented storm damage claims across Virginia Beach, Norfolk, Chesapeake, and Portsmouth on 17 years of Hampton Roads storm response &mdash; licensed, insured, BBB A+, and still answering 24/7 if the tree is still on the house.
          </p>
      ...
      <section className="bg-white py-16">
        <div className="container mx-auto max-w-4xl px-4">
          <div className="prose prose-lg max-w-none">
            ...
            <h2 className="text-3xl font-playfair font-bold text-[#1B4D3E] mt-10 mb-6">17 Years of Storm Response Experience</h2>
            <p className="text-lg text-gray-700 leading-relaxed mb-6">Mike Campbell built Art-is-Tree on 17 years of climbing experience in Hampton Roads including storm response work across the region's worst weather events. His team has cleared trees from residential rooftops in Kempsville and Great Neck, cut storm-dropped loblolly pines from vehicles in Red Mill and Sandbridge, and cleared debris from access routes in Chesapeake following major storm events. For storm-damaged trees requiring crane-assisted extraction, see our <Link to="/services/crane-removal" className="text-[#1B4D3E] underline hover:text-[#D4AF37] font-semibold">crane tree removal service</Link>.</p>
            ...
            <p className="text-lg text-gray-700 leading-relaxed mb-6">Two things worth reading before you sign anything after a storm: <Link to="/case-studies/tree-service-insurance" className="text-[#1B4D3E] underline hover:text-[#D4AF37] font-semibold">why the cheaper tree bid may not be insured for the work at all</Link>, and, if the tree came from next door, <Link to="/case-studies/virginia-tree-law" className="text-[#1B4D3E] underline hover:text-[#D4AF37] font-semibold">what Virginia tree law says about who is responsible</Link>.</p>
      ...
      <RelatedCaseStudies currentPath="/services/emergency-tree-service" preferred={['/case-studies/tree-service-insurance', '/case-studies/virginia-tree-law', '/case-studies/storm-damage-mitigation']} />
    </div>
  );
};
