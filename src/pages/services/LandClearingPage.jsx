      ...
      <section className="bg-gradient-to-br from-[#1B4D3E] to-[#0A2F24] pt-24 pb-16 px-4">
        <div className="container mx-auto max-w-5xl text-center">
          ...
          <p className="text-lg md:text-xl text-gray-200 max-w-3xl mx-auto mb-10 leading-relaxed">
            Whether you are clearing a residential lot for new construction, a commercial parcel for development, or an overgrown property for general cleanup, Art-is-Tree LLC handles land clearing across Virginia Beach, Chesapeake, Norfolk, and surrounding Hampton Roads. Licensed, insured, and equipped for any scale of clearing job.
          </p>
      ...
      <section className="bg-white py-16">
        <div className="container mx-auto max-w-4xl px-4">
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-lg text-gray-700 leading-relaxed mb-6">Art-is-Tree clears residential lots and commercial acreage across Virginia Beach, Chesapeake, Norfolk, and surrounding Hampton Roads for new construction, pool installations, additions, landscaping projects, and general property cleanup. We handle the full scope from the first assessment through final site preparation — not just the visible material above grade but the stumps, root systems, and organic debris below it that will affect how the cleared area performs over time.</p>
