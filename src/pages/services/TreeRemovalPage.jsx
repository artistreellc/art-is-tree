...
const TreeRemovalPage = () => {
  ...
  const faqData = [{
    ...
    answer: "Complete debris cleanup is included with every removal — we chip the brush, haul the wood, and rake the area so your yard looks better than when we arrived. Stump grinding is available as an add-on, ground below grade so you can sod, replant, or build over the spot with no leftover root system."
  }, {
            ...
            <ul className="space-y-6">
              <li className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">With 17 years of dedicated professional experience.</p>
                </div>
              </li>
              <li className="flex items-start">
                <div className="bg-[#1B4D3E]/10 p-3 rounded-full mr-4">
