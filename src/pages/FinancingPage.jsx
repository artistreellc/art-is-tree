...
const FinancingPage = () => {
  ...
  const description =
    'Tree service financing in Virginia Beach and Hampton Roads: Art-is-Tree LLC partners with Acorn Finance so you can get tree work done now and pay over time. Check your rate with no impact to your credit score, borrow $1,000 to $100,000, and choose terms up to 20 years.';
