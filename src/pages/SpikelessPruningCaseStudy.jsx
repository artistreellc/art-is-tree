...
const SpikelessPruningCaseStudy = () => {
  ...
  const description = 'Spikeless pruning in Virginia Beach — how rope-and-saddle climbing protects tree health, why spikes wound a living tree, and what ANSI A300 actually requires.';
      ...
      <article className="bg-[#FAF9F6]">
        ...
        <section className="container mx-auto px-4 max-w-4xl py-14 md:py-20">
          ...
          <div className="mt-8 space-y-5 text-gray-700 text-lg leading-relaxed">
            <p>
              This matters even more in our climate. <Link to="/service-areas" className="text-[#1B4D3E] font-semibold underline hover:text-[#D4AF37]">Hampton Roads</Link> is warm, humid, and wet a good part of the year — ideal conditions for the decay fungi that move into fresh wounds. A trunk full of spike holes in coastal Virginia isn’t a minor cosmetic issue; it’s an open invitation in the exact environment where rot spreads fastest. The trees we grow the most of here, from loblolly pines to live oaks and crepe myrtles, all do better when the trunk is left intact and the only cuts on the tree are the deliberate, clean pruning cuts up in the canopy.
            </p>
            <p>
