...
const CBPACaseStudy = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-12">
      <LocalSEOMeta 
        pageTitle="Chesapeake Bay Act Tree Permits VA | Art-is-Tree LLC"
        description="A real case study on navigating CBPA permits, RPA buffer zones, and marsh protection overlays on waterfront property in Virginia Beach and Hampton Roads."
      />
