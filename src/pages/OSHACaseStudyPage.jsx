...
const OSHACaseStudyPage = () => {
  ...
  const description = 'How a licensed, insured Virginia Beach tree service runs OSHA-compliant, ANSI Z133 work — approach distances to power lines, fall protection, PPE and rigging.';

  return (
    <>
      <LocalSEOMeta pageTitle="Tree Service Safety: OSHA &amp; ANSI Z133 | Virginia Beach" description={description} />
      <CaseStudySchema
        title={title}
      ...
      <article className="bg-[#FAF9F6]">
        ...
        <section className="container mx-auto px-4 max-w-4xl py-14 md:py-20">
          ...
          <div className="mt-6 space-y-5 text-gray-700 text-lg leading-relaxed">
            ...
            <p>
              We’re <Link to="/about" className="text-[#1B4D3E] font-semibold underline hover:text-[#D4AF37]">members of the International Society of Arboriculture</Link>, we work to that Z133 standard, we’re licensed, and we carry real liability and workers’ compensation insurance. That last part matters more than most homeowners think, and I’ll come back to why.
            </p>
          </div>
        </section>
