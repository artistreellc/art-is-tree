  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <section className="bg-[#1B4D3E] text-white pt-24 pb-16 relative overflow-hidden">
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?auto=format&fit=crop&q=80')] opacity-10 bg-cover bg-center mix-blend-overlay"></div>
      ...
      <section className="py-24 relative overflow-hidden bg-gradient-to-br from-[#1B4D3E] to-[#12362b]">
        <div className="absolute inset-0 opacity-10 bg-[url('https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?auto=format&fit=crop&q=80')] bg-cover bg-center"></div>
        <div className="container mx-auto px-4 relative z-10">
