...
const data = {
  ...
  introParagraphs: [
    'Virginia Beach is home base for Art-is-Tree LLC, and it’s where we do most of our work. We’re a licensed and insured tree service covering every corner of the city — from the Oceanfront and Chic’s Beach down to Sandbridge, Red Mill, and the open acreage of Pungo. Whether you need a hazardous tree removed off your roof in Kempsville, storm-prep pruning on the big live oaks in Great Neck, or a stump ground out flush in Thoroughgood, you get the same crew that’s been climbing these coastal trees for 17 years.',
  ...
  financingText: "Art-is-Tree LLC now offers tree service financing throughout Virginia Beach, so essential tree work never has to wait on your budget. From tree removal and trimming to stump grinding and 24/7 storm cleanup, our local financing lets Virginia Beach homeowners split the cost into affordable monthly payments instead of one lump sum. Whether it's a hazardous oak in Kempsville, a crane removal near the Oceanfront, or routine pruning in Great Neck, you can get professional, licensed, and insured tree care today and pay over time. Ask about our Virginia Beach tree service financing and flexible payment plans when you request your free written estimate — quick to apply.",
