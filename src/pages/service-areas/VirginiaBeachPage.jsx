...
const data = {
  ...
  neighborhoods: ['Oceanfront', 'Great Neck', 'Kempsville', 'Kings Grant', 'Courthouse', 'Sandbridge', 'Thoroughgood', 'Chic’s Beach', 'Red Mill', 'Pungo', 'Bayside', 'Town Center', 'Alanton', 'Little Neck', 'Hilltop', 'Nimmo'],
  services: [
