...
const data = {
  ...
  services: [
    ...
    { iconKey: 'crane', kw: 'Crane-Assisted Removal in Chesapeake', text: 'When a tree is too large or too close to the house to fell, our crane tree removal lifts it out in controlled sections — the safest option on Chesapeake’s tighter suburban lots.' },
    { iconKey: 'trim', kw: 'Tree Trimming & Pruning in Chesapeake', text: 'Regular tree trimming and pruning in Chesapeake keeps your canopy strong, off the roof, and ready for hurricane season. We climb spikeless to protect mature hardwoods from Greenbrier to Great Bridge.' },
    { iconKey: 'stump', kw: 'Stump Grinding in Chesapeake', text: 'Grinding stumps below grade so you can reclaim the yard — part of a Chesapeake removal or a standalone stump grinding service.' },
    { iconKey: 'emergency', kw: '24/7 Emergency Tree Service in Chesapeake', text: 'Storms roll through Chesapeake hard. Our emergency tree service answers 24/7 to clear fallen trees, secure hanging limbs, and reopen driveways and roads.' },
    { iconKey: 'land', kw: 'Land & Lot Clearing in Chesapeake', text: 'Out toward Hickory, Fentress, and the Dismal Swamp edge, we clear acreage, brush, and overgrowth so you can build, farm, or open up your Chesapeake property.' },
  ],
