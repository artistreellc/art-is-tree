...
const data = {
  ...
  services: [
    ...
    { iconKey: 'trim', kw: 'Tree Trimming & Pruning', text: 'Tree trimming and pruning in Norfolk keeps the city’s live oaks and water oaks healthy and cuts their wind resistance before hurricane season. We climb spikeless to protect the trees while we shape and deadwood them.' },
