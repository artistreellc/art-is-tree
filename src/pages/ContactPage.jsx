            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
              ...
              <div className="lg:col-span-2 space-y-8 lg:order-2">
                <div className="prose prose-lg text-gray-700 bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
                  ...
                  <p>
                    Bringing 17 years of elite climbing experience to every job, <strong>Art-is-Tree LLC</strong> is your premier choice when you need to <strong>contact tree service Virginia Beach</strong> professionals. We are a locally owned and operated, <Link to="/case-studies/tree-service-insurance" className="text-[#1B4D3E] underline hover:text-[#D4AF37] font-semibold">fully licensed and insured tree service</Link> provider dedicated to absolute excellence in arboriculture. 
                  </p>
                  <p>
